...
export default function DraftCoursesPage() {
  ...
  const courses = data?.data?.filter((c) => c.is_published === false) || [];
  ...
  if (!courses.length)
    return <EmptyState description="No draft courses found." />;
      ...
      <header className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 border-b pb-4 mb-2">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Manage your saved draft courses before publishing.
          </p>
        </div>
      </header>
        ...
        {courses.map((course) => (
          ...
          >
            ...
            <div
              ...
              onClick={() => navigate(`/instructor/course/content/${course.id}/detail`)}
            >
              <img
                src={
            ...
            <div className="p-5 flex flex-col flex-1 justify-between">
              ...
              <div className="mt-4">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium bg-brand-500 text-white rounded-md hover:bg-brand-700 transition-all duration-200"
                >
                  <BookOpen size={16} />
                  Manage Course
                </button>
