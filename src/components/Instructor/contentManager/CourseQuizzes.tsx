...
const CourseQuizzes: FC<CourseQuizzesProps> = ({
  ...
  return (
    <section className="bg-white dark:bg-neutral-900 rounded-lg shadow-sm border border-brand-500 dark:border-neutral-800 p-2">
      {/* Header */}
            ...
            >
              ...
              {(onEditQuiz || onDeleteQuiz) && (
                <div className="flex flex-wrap justify-center sm:justify-start gap-2">
                  <button
                    className="flex items-center gap-2 px-3 py-1.5 text-xs font-medium text-white bg-brand-500 rounded-lg hover:bg-brand-700 transition"
                    onClick={() =>
                      navigate(
                  ...
                  {onEditQuiz && (
                    <button
                      className="px-4 py-2 text-xs text-white bg-brand-500 rounded hover:bg-brand-700"
